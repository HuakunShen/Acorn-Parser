...
const tableStr2TableObj = (table_str, sessionStr, gpaStr) => {
    ...
    return Object.assign({ courses, year: parseInt(year), season }, gpaObj);
};
...
const table_objs = tables.map((table_str) => tableStr2TableObj(table_str, '2017 Fall - 1st Year Studies in Computer Science - University College      ', 'Sessional GPA   2.95  Annual GPA      3.09  Cumulative GPA  3.09            Status: In good standing     '));
log(table_objs);
